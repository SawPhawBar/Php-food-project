        ...
        <div class="container mt-3 pt-5">
            <div class="row">
                <div class="col-12">
                    ...
                    <h2 class="text-center">Welcome! <?php echo "<font color=blue>".$_REQUEST['name']."</font>"; ?></h2>
                    <h3 class="text-center">You have created your account successfully!</h3>
                    ...
                    <p class="text-center"><a href="?log=out">Go back</a></p>
                </div>
